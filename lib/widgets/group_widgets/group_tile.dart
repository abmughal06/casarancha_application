                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          SelectableTextWidget(
                            text:
                                "${group.memberIds.length.toString()} ${group.memberIds.length > 1 ? appText(context).strMembers : appText(context).strMembers}",
                            fontSize: 12.sp,
...
class GroupTilePrivate extends StatelessWidget {
  const GroupTilePrivate({
    super.key,
    required this.group,
    required this.ontapTrailing,
    this.isSearchScreen = false,
